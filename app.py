...
def analyze_ad(text):
    ...
    # Keyword flagging
    flagged = [kw for kw in BIAS_KEYWORDS if kw in text_lower]

    # Bias verdict
    is_biased = len(flagged) > 0

    # Bias score 0-100
    bias_score = min(len(flagged) * 25, 100)
...
def get_bias_explanation(keyword):
    explanations = {
        ...
        "slay the day": "Culturally coded language targeting Black women",
        "motherland": "Racially coded reference targeting Black demographics",
        "soul food": "Racial cultural stereotype targeting Black demographics",
        ...
        "hustler like you": "Socioeconomic stereotype targeting Black men",
        "daily grind": "Socioeconomic stereotype targeting Black demographics",
        # Hispanic coding
        "viva la moda": "Spanish language racial coding targeting Hispanic demographics",
        "viva la aventura": "Spanish language racial coding targeting Hispanic demographics",
        "la vida loca": "Hispanic cultural stereotype",
        "abuela's kitchen": "Hispanic cultural stereotype targeting family roles",
        "buen provecho": "Spanish language racial coding",
        # Asian coding
        "ancient wisdom": "Asian cultural stereotype",
        ...
        # Middle Eastern
        "mosques of marrakech": "Middle Eastern geographic stereotype",
        "desert spirit": "Middle Eastern cultural stereotype",
        # Gender coding
        "girl boss": "Gender stereotype targeting women",
        "lady boss": "Gender stereotype targeting women",
        "real man": "Gender stereotype targeting men",
...
if page == "🔍 Analyze Ad":
    ...
    with col1:
        race = st.selectbox("Target Race",
                            ["White", "Black", "Asian",
                             "Hispanic", "Middle Eastern", "Other/General"])
    with col2:
        ...
        if not ad_text.strip():
            ...
            if result["is_biased"]:
                ...
                <div class="bias-box">
                    ...
                    <p>This ad contains <strong>{len(result['flagged_keywords'])} 
            ...
            # Flagged keywords with explanations
            if result["flagged_keywords"]:
                st.subheader("🚩 Bias Indicators Found")
...
# ============================================================
    ...
    <div class="step-box">
        ...
        <ul>
            ...
            <li><strong>Flagged Keywords</strong> — exact words or phrases 
            that triggered the bias detection with explanations</li>
            <li><strong>Highlighted Ad</strong> — your original ad with 
            biased phrases highlighted in red</li>
            <li><strong>Recommendation</strong> — specific advice on how 
            to rewrite the ad</li>
        </ul>
    </div>
    """, unsafe_allow_html=True)
    ...
    **Tip 4 — A clean result does not guarantee no bias**
    ...
    with st.expander("Why is my ad flagged even though it seems fine?"):
        ...
        as racially or gender coded based on analysis of 150 AI-generated ads. 
    ...
    with st.expander("How accurate is this tool?"):
        st.write("""
        The bias detection pipeline was validated on 150 AI-generated ads 
        and achieved high accuracy. However no automated tool is perfect — 
